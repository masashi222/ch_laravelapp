@extends('layouts.base') @section('title','Owner/UserInfoRegister')
...
@slot('menu_main') ユーザー情報登録画面 @endslot @endcomponent
<form method="post" action="{{ route('owner.user_info_register_send') }}" class="row py-2 my-3">
	@csrf
